...
// Generate a random number in the int32 range
function makeNonce() {
...
// Determine the algorithm according to the key length, only supports 16 24 32 bits
...
// AES encryption, use mode: CBC/PKCS5Padding
...
function generateToken04(
  ...
  // Randomly generated 16-byte string, used as AES encryption vector, before the ciphertext for Base64 encoding to generate the final token
  var iv = makeRandomIv();
  console.log("iv", iv);
  /// Encrypt
